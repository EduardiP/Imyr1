...
// Rreshtin e Imyr-it ngjite NJE HERE te layout() me poshte; vlen per te 3 faqet e PostaPro.
...
const feats = ["Fushata të automatizuara", "Sekuenca mirëseardhjeje", "Raporte hapjesh & klikimesh"].map(function(v){ return '<div class="feat"><b>&#10003;</b> ' + v + '</div>'; }).join('');

const faqet = {
  ballina: function(){ return layout('ballina', `
<div class="wrap">
  <h1>PostaPro</h1>
  <p class="lead">Email marketing & fushata automatike për rritjen tënde.</p>
  <a class="cta" href="/demo/posta/regjistrohu">Krijo llogari &rarr;</a>
  <div class="feats">${feats}</div>
  <p style="color:#555;">PostaPro ndihmon bizneset të dërgojnë newsletter, fushata të automatizuara dhe email-e transaksionale.</p>
