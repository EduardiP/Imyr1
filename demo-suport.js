...
// Rreshtin e Imyr-it ngjite NJE HERE te layout() me poshte; vlen per te 3 faqet e SuportDesk.
...
const feats = ["Inbox i unifikuar", "Menaxhim tiketash", "Bazë njohurish (help center)"].map(function(v){ return '<div class="feat"><b>&#10003;</b> ' + v + '</div>'; }).join('');
...
<div class="wrap">
  ...
  <p style="color:#555;">SuportDesk është një help-desk për ekipet e mbështetjes. Mblidh email, chat dhe mesazhe në një inbox.</p>
