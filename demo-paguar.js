...
// Rreshtin e Imyr-it ngjite NJE HERE te layout() me poshte; vlen per te 3 faqet e PaguarFlow.
...
<!-- Imyr: NJE rresht, ne layout => vlen per TE GJITHA faqet e PaguarFlow -->
<script src="${BASE}/imyr.js" data-key="${CELESI}"></script>
</body>
</html>`;
}

const feats = ["Abonime & fatura periodike", "Pagesa me kartë & wallet", "Panel të ardhurash në kohë reale"].map(function(v){ return '<div class="feat"><b>&#10003;</b> ' + v + '</div>'; }).join('');
...
<div class="wrap">
  ...
  <p style="color:#555;">PaguarFlow është një platformë pagesash për bizneset SaaS. Menaxho abonime, fatura periodike dhe pagesa me kartë, pa u marrë me infrastrukturën.</p>
